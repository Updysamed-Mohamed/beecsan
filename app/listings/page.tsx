...
// ✅ Tani waa qaybtii koodhkaaga oo dhan
function ListingDetailContent() {
  ...
  const handleShare = async () => {
    try {
      ...
      if (canShare.value) {
        await Share.share({
          title: product?.title || 'Beecsan',
          text: `Ka eeg ${product?.title} gudaha Beecsan!`,
          url: window.location.href,
          dialogTitle: 'La wadaag asxaabta',
        });
      } else {
  ...
  const handleReportSubmit = async () => {
    ...
    try {
      ...
      alert('Mahadsanid! Warbixintaada waa la helay.');
...
// ✅ KAN AYAA XALKA AH: Export-ka rasmiga ah oo Suspense ku jira
